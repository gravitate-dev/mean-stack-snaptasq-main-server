angular.module('snaptasqApp').directive('friendtaskslist', function($parse, $location, Task, SnapListResultManager) {
    return {
        restrict: 'ACE',
        ...
        templateUrl: 'components/snaplist/friend/friendtaskslist/friendtaskslist.template.html',
