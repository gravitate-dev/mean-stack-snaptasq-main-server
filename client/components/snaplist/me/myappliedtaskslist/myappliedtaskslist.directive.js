angular.module('snaptasqApp').directive('myappliedtaskslist', function($parse, $location, Task, SnapListResultManager) {
    return {
        restrict: 'ACE',
        ...
        templateUrl: 'components/snaplist/me/myappliedtaskslist/myappliedtaskslist.template.html',
