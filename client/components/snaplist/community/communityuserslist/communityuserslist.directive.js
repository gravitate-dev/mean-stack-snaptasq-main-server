angular.module('snaptasqApp').directive('communityuserslist', function($parse, $location, Community, SnapListResultManager, Modal) {
    return {
        restrict: 'ACE',
        ...
        controller: function($scope) {
            ...
            $scope.loadMore = function() {
                if (manager.canLoadMore()) {
                    ...
                    Community.getMembers($scope.id, function(data) {
