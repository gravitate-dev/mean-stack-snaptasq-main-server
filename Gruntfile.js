...
module.exports = function (grunt) {
  ...
  watch: {
    ...
    wiredep: {
      target: {
        ...
        exclude: [/bootstrap-sass-official/, /bootstrap.js/, '/json3/', '/es5-shim/', /bootstrap.css/, /font-awesome.css/, 'bower_components/raf.js/'  ]
      }
    },
  ...
  grunt.registerTask('getlatest', [
    'gitreset',
    'gitpull', 
    'jsbeautifier:default'
    ]);
  grunt.registerTask('pushchanges', [
    'jsbeautifier:default',
    'gitadd',
    'gitcommit',
    'gitpush'
