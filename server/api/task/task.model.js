...
var TaskSchema = new Schema({
  ...
  ownerPic:String,
  description:String,
  tasker: {id: Schema.Types.ObjectId, name:String,pic:{ type: String, default:config.host.url+"assets/logos/no_avatar.gif"},fbId:String,confirmed:{ type:Boolean, default: false } },
  ...
  applicants:[
  {id: Schema.Types.ObjectId, name:String,pic:{ type: String, default:config.host.url+"assets/logos/no_avatar.gif"},fbId:String}
  ],
  location: {
  	name: String,
