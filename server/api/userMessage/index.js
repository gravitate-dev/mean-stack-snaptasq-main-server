...
router.get('/:id/thread', auth.isAuthenticated(), controller.doesUserOwnAndSeeMessageThread, controller.getMessageThreadById);
router.get('/:id/thread/messages', auth.isAuthenticated(), controller.doesUserOwnAndSeeMessageThread, controller.getMessagesByThreadId);
