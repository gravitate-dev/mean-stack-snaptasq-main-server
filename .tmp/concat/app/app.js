...
angular.module('snaptasqApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/communities/communities.html',
    "<div class=container><section class=col-md-12 style=margin-top:50px><div class=\"panel panel-info\"><div class=panel-body><h1 style=display:inline class=text-center>Public Community Tasqs</h1><!-- <button class=\"btn btn-info pull-right\" ng-click=\"showSuggestCommunityModal()\"><i class=\"fa fa-plus\"></i>&nbsp;Suggest Community</button> --><ul><li ng-repeat=\"item in publicCommunities\"><a href=/community/{{item._id}} class=lead>{{item.name}}</a></li></ul></div></div></section><section class=col-md-12 style=margin-top:50px><div class=\"panel panel-info\"><div class=panel-body><h1 style=display:inline class=text-center>Private Community Tasqs</h1><!-- <button class=\"btn btn-info pull-right\" ng-click=\"showSuggestCommunityModal()\"><i class=\"fa fa-plus\"></i>&nbsp;Suggest Community</button> --><ul><li ng-repeat=\"item in privateCommunities\"><a href=/community/{{item._id}} class=lead>{{item.name}} Tasqs</a></li><li ng-if=!privateCommunities>None</li></ul></div></div></section></div>"
  );
  ...
  $templateCache.put('app/communities/partials/join.community.html',
    "<div class=row><div class=\"col-md-12 text-center\"><p>{{group.entryQuestion}}</p><input ng-model=\"creds\"/> <button class=btn ng-click=requestJoin(creds)>Join</button></div></div>"
  );


  $templateCache.put('app/communities/partials/main.community.html',
    "<div class=row><div class=col-md-12>Welcome Member</div></div>"
  );
